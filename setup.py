...
DENO_URL = "https://github.com/denoland/deno/releases/download/v0.16.0/deno_win_x64.zip"
DENO_STD_URL = "https://github.com/denoland/deno_std/archive/v0.16.0.zip"
...
## Finalising
os.rename("lib/deno_std-0.16.0","lib/deno_std")
